...
# Cyber Security Base 2024 - Project 1 - OWASP Top 10

We have been instructed to implement and then fix _at least 5_ application security risks from the [OWASP Top 10](https://owasp.org/www-project-top-ten/) of security risks on web applications. Additionally missing CSRF has been given 'good-to-go' while missing from both the 2017 and 2021 editions of the OWASPs lists.

## Selected list version

I've selected the more recent, 2021 edition of the Top 10 risk list, to be my reference for this project.
